...
import char from './Images/characters.jpg'
    ...
    <>
      <div className='header'>
        <div className='logoBar'>
          <img className='logoImg' src={logo} alt='Logo do jogo MapleStory' />
          <img className='characterImg' src={char} alt='Personagens do jogo MapleStory' />
        </div>
      </div>
      <div className='body'>
